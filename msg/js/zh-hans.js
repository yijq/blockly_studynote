...
Blockly.Msg.BEGIN_WHEN = "当";
Blockly.Msg.BEGIN = "开始";
Blockly.Msg.BEGIN_BTN = "按钮被按下";
Blockly.Msg.BEGIN_OBS = "检测到障碍物";

Blockly.Msg.MOVE_FORWARD = "向前移动";
Blockly.Msg.MOVE_FORWARD_DURATION = "秒";
Blockly.Msg.MOVE_FORWARD_SPEED = "速度";
Blockly.Msg.MOVE_FORWARD_SPEED_UNIT = "厘米/秒";

Blockly.Msg.MOVE_BACKWARD = "向后移动";
Blockly.Msg.MOVE_BACKWARD_DURATION = "秒";
Blockly.Msg.MOVE_BACKWARD_SPEED = "速度";
Blockly.Msg.MOVE_BACKWARD_SPEED_UNIT = "厘米/秒";

Blockly.Msg.MOVE_MANUAL = "自由移动";
Blockly.Msg.MOVE_MANUAL_LEFT_SPEED = "左轮速度";
Blockly.Msg.MOVE_MANUAL_RIGHT_SPEED = "右轮速度";
Blockly.Msg.MOVE_MANUAL_SPEED_UNIT = "厘米/秒";

Blockly.Msg.TURN = "旋转";
Blockly.Msg.TURN_LEFT = "向左";
Blockly.Msg.TURN_RIGHT = "向右";
Blockly.Msg.TURN_ANGLE = "度";
Blockly.Msg.TURN_SPEED = "速度";
Blockly.Msg.TURN_SPEED_UNIT = "度/秒";

Blockly.Msg.SET_WHEEL_SPEED = "设置两轮转速";
Blockly.Msg.LEFT_WHEEL = "左轮";
Blockly.Msg.RIGHT_WHEEL = "右轮";
Blockly.Msg.SPEED = "速度";

Blockly.Msg.STOP = "停止";

Blockly.Msg.FORWARD = "向前";
Blockly.Msg.BACKWARD = "向后";
Blockly.Msg.SPEED_FAST = "高速";
Blockly.Msg.SPEED_MIDDLE = "中速";
Blockly.Msg.SPEED_SLOW = "低速";

Blockly.Msg.FACE_DISPLAY = "显示表情";
Blockly.Msg.FACE_DISPLAY_MANUAL = "显示自定义表情";
Blockly.Msg.FACE_INDEX_01 = "快乐";
Blockly.Msg.FACE_INDEX_02 = "紧张";
Blockly.Msg.FACE_INDEX_03 = "伤心";
Blockly.Msg.FACE_INDEX_04 = "生气";
Blockly.Msg.FACE_INDEX_05 = "惊呆";
Blockly.Msg.FACE_INDEX_06 = "卖萌";
Blockly.Msg.FACE_INDEX_07 = "无语";
Blockly.Msg.FACE_INDEX_08 = "大哭";
Blockly.Msg.FACE_INDEX_09 = "超喜欢";
Blockly.Msg.FACE_INDEX_10 = "全灭";
Blockly.Msg.FACE_INDEX_11 = "全亮";

Blockly.Msg.SOUND = "播放声音";
Blockly.Msg.SOUND_INDEX_01 = "开心";
Blockly.Msg.SOUND_INDEX_02 = "勇敢";
Blockly.Msg.SOUND_INDEX_03 = "警惕";
Blockly.Msg.SOUND_INDEX_04 = "好奇";
Blockly.Msg.SOUND_INDEX_05 = "受挫";
Blockly.Msg.SOUND_INDEX_06 = "快乐";
Blockly.Msg.SOUND_INDEX_07 = "可爱";
Blockly.Msg.SOUND_INDEX_08 = "惊讶";
Blockly.Msg.SOUND_INDEX_09 = "动物";
Blockly.Msg.SOUND_INDEX_10 = "车辆";
Blockly.Msg.SOUND_INDEX_11 = "效果";
Blockly.Msg.SOUND_INDEX_12 = "其他";

Blockly.Msg.SOUND_FREQUENCY = "音符";
Blockly.Msg.SOUND_DURATION = "节拍";
...
Blockly.Msg.CONTROL_WAITING = "等待";
Blockly.Msg.CONTROL_WAITING_SEC = "秒";
Blockly.Msg.CONTROL_WAITING_BTN = "直到按钮被按下";

Blockly.Msg.CONTROL_REPEAT = "重复";
Blockly.Msg.CONTROL_REPEAT_TIMES = "次";
Blockly.Msg.CONTROL_REPEAT_ALWAYS = "一直重复";

Blockly.Msg.CONTROL_IF = "如果";
Blockly.Msg.CONTROL_ELSE = "否则";
Blockly.Msg.CONTROL_DEVICE = "设备";
Blockly.Msg.CONTROL_OBS = "检测到有障碍";
Blockly.Msg.CONTROL_BTN = "检测到按钮被按下";

Blockly.Msg.CONTROL_BREAK = "中断重复执行";

Blockly.Msg.VAR_SET = "设置";
Blockly.Msg.VAR_RANDOM = "随机数";
Blockly.Msg.VAR_USE = "用";

Blockly.Msg.LOGIC_IF = "如果";
Blockly.Msg.LOGIC_ELSE = "否则";
Blockly.Msg.LOGIC_REPEAT = "重复当";
Blockly.Msg.LOGIC_REPEAT_UNTIL = "重复直到";
...
Blockly.Msg.CATEGORY_BEGIN = "开始";
Blockly.Msg.CATEGORY_MOVE = "移动";
Blockly.Msg.CATEGORY_FACE = "表情";
